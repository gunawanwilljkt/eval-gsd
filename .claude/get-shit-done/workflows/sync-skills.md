...
INSTALL_JS_GLOBAL="/Users/gunawanwilljkt/harness/eval-gsd/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/gunawanwilljkt/harness/eval-gsd/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
