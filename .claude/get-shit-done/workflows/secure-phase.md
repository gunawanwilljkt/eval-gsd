...
```
Agent(
  prompt="Read /Users/gunawanwilljkt/harness/eval-gsd/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/gunawanwilljkt/harness/eval-gsd/.claude/get-shit-done/templates/SECURITY.md`
...
▶ /gsd-verify-work {N}       verify eval coverage + run UAT
```
