...
<required_reading>
@/Users/gunawanwilljkt/harness/eval-gsd/.claude/get-shit-done/references/ai-frameworks.md
...
```markdown
Read /Users/gunawanwilljkt/harness/eval-gsd/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/gunawanwilljkt/harness/eval-gsd/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/gunawanwilljkt/harness/eval-gsd/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/gunawanwilljkt/harness/eval-gsd/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/gunawanwilljkt/harness/eval-gsd/.claude/agents/gsd-eval-planner.md for instructions.
