...
- **Global scope**: `/Users/gunawanwilljkt/harness/eval-gsd/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/gunawanwilljkt/harness/eval-gsd/.claude/notes/`)
...
2. Glob `/Users/gunawanwilljkt/harness/eval-gsd/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/gunawanwilljkt/harness/eval-gsd/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/gunawanwilljkt/harness/eval-gsd/.claude/notes/` — works in any directory
