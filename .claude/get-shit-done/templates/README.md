...
| `LEDGER.md` | `ledger.md` | `/gsd-execute-phase` (sole writer), `/gsd-autonomous` | Two-tier work ledger: always-read HEAD + append-only task history for cross-session resume |
...
| `NN-EVAL-CONTRACT.md` | `eval-contract.md` | `/gsd-spec-phase`, `/gsd-discuss-phase` | Eval contract authored + locked at spec time; gates plan-phase and verify-phase |
| `NN-UAT.md` | `UAT.md` | `/gsd-verify-work` | User acceptance test results |
