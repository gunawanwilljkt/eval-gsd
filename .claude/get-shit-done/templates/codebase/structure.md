...
- Usage: Reference from command with `@/Users/gunawanwilljkt/harness/eval-gsd/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/gunawanwilljkt/harness/eval-gsd/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/gunawanwilljkt/harness/eval-gsd/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
