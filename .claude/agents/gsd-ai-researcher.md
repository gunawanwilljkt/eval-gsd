...
<required_reading>
Read `/Users/gunawanwilljkt/harness/eval-gsd/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
