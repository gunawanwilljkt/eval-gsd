...
<reference>
@/Users/gunawanwilljkt/harness/eval-gsd/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/gunawanwilljkt/harness/eval-gsd/.claude/get-shit-done/references/user-profiling.md` to load:
